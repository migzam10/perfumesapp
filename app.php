...
<script src="assets/js/venta.js?v=2.0"></script>
<script src="assets/js/historial.js?v=2.0"></script>
<script src="assets/js/inventario.js?v=2.0"></script>
<script src="assets/js/reportes.js?v=2.0"></script>
<script src="assets/js/cierre.js?v=2.0"></script>
<script src="assets/js/compras.js?v=2.0"></script>
