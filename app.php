...
<script src="assets/js/venta.js?v=3.1"></script>
<script src="assets/js/historial.js?v=3.1"></script>
<script src="assets/js/inventario.js?v=3.1"></script>
<script src="assets/js/reportes.js?v=3.1"></script>
<script src="assets/js/cierre.js?v=3.1"></script>
<script src="assets/js/compras.js?v=3.1"></script>
<script src="assets/js/admin.js?v=3.1"></script>
</body>
</html>
